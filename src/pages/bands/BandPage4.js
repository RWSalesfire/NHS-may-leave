...
const CURRENT_BAND = 4;

export default function BandPage4() {
  usePageMeta({
    title: 'NHS Maternity Pay Band 4 2026 | Calculator & Guide',
    description:
      'NHS maternity pay for Band 4 assistant practitioners and senior admin. See week-by-week breakdown, take-home estimates, and how to boost your pay. Free calculator.',
  });
  ...
  return (
    <Article style={styles.container}>
      <View style={styles.content}>
        <PageHeader
          title="NHS Maternity Pay - Band 4"
          subtitle="Assistant practitioners, medical secretaries, clinical coders and senior admin"
        />
        ...
        <Section style={styles.section}>
          ...
          <View style={[styles.salaryCard, shadows.md]}>
            <View style={styles.salaryRow}>
              ...
              <Text style={styles.salaryValue}>{'\u00A3'}26,500 - {'\u00A3'}29,000</Text>
            </View>
            <View style={styles.salaryDivider} />
            <View style={styles.salaryRow}>
              <Text style={styles.salaryLabel}>Midpoint Salary</Text>
              <Text style={styles.salaryValue}>{'\u00A3'}27,750</Text>
            </View>
            <View style={styles.salaryDivider} />
            <View style={styles.salaryRow}>
              <Text style={styles.salaryLabel}>Weekly Pay (approx.)</Text>
              <Text style={styles.salaryValue}>{'\u00A3'}534</Text>
            </View>
          </View>
          <Text style={styles.paragraph}>
            Band 4 roles include assistant practitioners, medical secretaries, clinical coders and
            senior administrative staff. These positions often require foundation degrees or
        ...
        <Section style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Based on the midpoint salary of {'\u00A3'}27,750 ({'\u00A3'}534/week), here is what you
        ...
        <View style={[styles.totalCard, shadows.md]}>
          ...
          <Text style={styles.totalAmount}>{'\u00A3'}14,798</Text>
          <Text style={styles.totalNote}>
            At Band 4, your half pay + SMP period ({'\u00A3'}452/week) retains around 85% of your
            normal weekly earnings. The SMP-only period represents about 35% of your usual pay.
          </Text>
        </View>
        ...
        <Section style={styles.section}>
          ...
          <View style={[styles.exampleCard, shadows.sm]}>
            ...
            <Text style={styles.exampleText}>
              ...
              weekly pay rises to {'\u00A3'}684. This increases your full pay period to {'\u00A3'}684/week
              and your half pay to {'\u00A3'}342 + SMP. Over 39 weeks, that could add over{' '}
