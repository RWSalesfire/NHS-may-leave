...
const OTHER_BANDS = [
  ...
  { label: 'Band 5', path: '/nhs-maternity-pay-band-5', current: true },
...
export default function BandPage5() {
  usePageMeta({
    title: 'NHS Maternity Pay Band 5 2026 | Calculator & Guide',
    description: 'NHS maternity pay for Band 5 registered nurses, midwives and AHPs. See week-by-week breakdown, take-home estimates, and how to boost your pay. Free calculator.',
  });
  ...
  return (
    <Article style={styles.container}>
      <View style={styles.content}>
        <PageHeader
          title="NHS Maternity Pay: Band 5"
          subtitle="Registered Nurse, Midwife and Allied Health Professional"
        />
        ...
        <Section style={styles.section}>
          ...
          <View style={[styles.overviewCard, shadows.md]}>
            <View style={styles.overviewRow}>
              ...
              <Text style={styles.overviewValue}>{'\u00A3'}31,000 - {'\u00A3'}34,500</Text>
            </View>
            <View style={styles.overviewDivider} />
            <View style={styles.overviewRow}>
              <Text style={styles.overviewLabel}>Midpoint Salary</Text>
              <Text style={styles.overviewValue}>{'\u00A3'}32,750</Text>
            </View>
            <View style={styles.overviewDivider} />
            <View style={styles.overviewRow}>
              <Text style={styles.overviewLabel}>Weekly Pay (approx.)</Text>
              <Text style={styles.overviewValue}>{'\u00A3'}630</Text>
            </View>
          </View>
          <Text style={styles.paragraph}>
            Band 5 covers newly qualified clinical staff including staff nurses, midwives,
            physiotherapists, occupational therapists, radiographers and paramedics. It is the
            most common starting band for clinical roles in the NHS.
          </Text>
        </Section>
        ...
        <Section style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Based on the Band 5 midpoint salary of {'\u00A3'}32,750 ({'\u00A3'}630/week):
          </Text>
          <View style={styles.payStructure}>
            {[
              ...
              },
              {
                ...
                desc: 'Half salary (\u00A3315) plus Statutory Maternity Pay (\u00A3184.75).',
                amount: '\u00A3500/week',
                total: '\u00A38,996 total',
              },
              {
        ...
        <View style={[styles.totalCard, shadows.md]}>
          ...
          <Text style={styles.totalValue}>{'\u00A3'}16,436</Text>
        ...
        <Section style={styles.section}>
          ...
          <View style={[styles.exampleCard, shadows.sm]}>
            ...
            <Text style={styles.exampleText}>
              ...
              your AWE rises from {'\u00A3'}630 to {'\u00A3'}780/week. That means:
            </Text>
            <View style={styles.list}>
              <Text style={styles.listItem}>{'\u2022'} Weeks 1-8 full pay: {'\u00A3'}780/week instead of {'\u00A3'}630</Text>
              <Text style={styles.listItem}>{'\u2022'} Weeks 9-26 half pay: {'\u00A3'}390 + SMP instead of {'\u00A3'}315 + SMP</Text>
              <Text style={styles.listItem}>{'\u2022'} Potential extra {'\u00A3'}2,550+ over the full maternity pay period</Text>
            </View>
          </View>
          <Text style={styles.paragraph}>
            Band 5 is the most common band for newly qualified clinical staff. Bank shifts through
            your Trust's internal bank can significantly boost your AWE. Make sure any extra shifts
            are paid through your Trust payroll, not via an external agency.
          </Text>
        </Section>

        {/* CTA */}
        <View style={styles.ctaSection}>
          <Text style={styles.ctaTitle}>Get Your Exact Band 5 Maternity Pay</Text>
