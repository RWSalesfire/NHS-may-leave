...
export default function BandPage2() {
  usePageMeta({
    title: 'NHS Maternity Pay Band 2 2026 | Calculator & Guide',
    description:
      'NHS maternity pay for Band 2 healthcare assistants and support workers. See week-by-week breakdown, take-home estimates, and how to boost your pay. Free calculator.',
  });
  ...
  return (
    <Article style={styles.container}>
      <View style={styles.content}>
        <PageHeader
          title="NHS Maternity Pay - Band 2"
          subtitle="Healthcare assistants, porters, receptionists and domestic staff"
        />
        ...
        <Section style={styles.section}>
          ...
          <View style={[styles.salaryCard, shadows.md]}>
            <View style={styles.salaryRow}>
              ...
              <Text style={styles.salaryValue}>{'\u00A3'}23,500 - {'\u00A3'}25,000</Text>
            </View>
            <View style={styles.salaryDivider} />
            <View style={styles.salaryRow}>
              <Text style={styles.salaryLabel}>Midpoint Salary</Text>
              <Text style={styles.salaryValue}>{'\u00A3'}24,250</Text>
            </View>
            <View style={styles.salaryDivider} />
            <View style={styles.salaryRow}>
              <Text style={styles.salaryLabel}>Weekly Pay (approx.)</Text>
              <Text style={styles.salaryValue}>{'\u00A3'}466</Text>
            </View>
          </View>
          <Text style={styles.paragraph}>
            Band 2 roles include healthcare assistants, porters, receptionists and domestic staff.
            These are entry-level clinical and support positions within the NHS.
          </Text>
        </Section>
        ...
        <Section style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Based on the midpoint salary of {'\u00A3'}24,250 ({'\u00A3'}466/week), here is what you
        ...
        <View style={[styles.totalCard, shadows.md]}>
          ...
          <Text style={styles.totalAmount}>{'\u00A3'}13,653</Text>
          <Text style={styles.totalNote}>
            At Band 2, SMP ({'\u00A3'}184.75/week) represents around 40% of your weekly salary.
            This means the drop in income during the SMP-only period is less steep compared to
            higher bands.
          </Text>
        </View>
        ...
        <Section style={styles.section}>
          ...
          <View style={[styles.exampleCard, shadows.sm]}>
            ...
            <Text style={styles.exampleText}>
              ...
              weekly pay rises to {'\u00A3'}616. This increases your full pay period to {'\u00A3'}616/week
              and your half pay to {'\u00A3'}308 + SMP. Over 39 weeks, that could add over{' '}
