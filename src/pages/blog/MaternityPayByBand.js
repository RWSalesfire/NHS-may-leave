...
export default function MaternityPayByBand({ post, styles, CATEGORY_COLORS }) {
  return (
    <View>
      ...
      <H2 style={styles.articleHeading}>How NHS Pay Bands Work (Quick Recap)</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Band 2: Healthcare Assistant / Support Worker</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Band 5: Registered Nurse / Midwife / AHP</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Band 6: Senior Nurse / Specialist / Team Leader</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Band 7: Advanced Practitioner / Ward Manager</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Band 8a: Principal / Service Manager</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>The Key Pattern: SMP Is the Equaliser</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Part-Time and Compressed Hours</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>How to Increase Your Maternity Pay</H2>
      <Text style={styles.articleBody}>
      ...
      <H2 style={styles.articleHeading}>Get Your Personalised Breakdown</H2>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleBody}>
        For a full explanation of how your pay is structured, read our{' '}
        ...
        . If you are planning your finances, our{' '}
        ...
        {' '}has practical tips for every band.
      </Text>
