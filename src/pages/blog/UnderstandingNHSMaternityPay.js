...
export default function UnderstandingNHSMaternityPay({ post, styles, CATEGORY_COLORS }) {
  return (
    <View>
      ...
      <Text style={styles.articleHeading}>Two Types of Maternity Pay: OMP and SMP</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>Eligibility: Who Qualifies for What</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>The NHS Maternity Pay Structure: Week by Week</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>How Average Weekly Earnings (AWE) Affects Your Pay</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>Worked Example: Band 5 Nurse</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>The 3-Month Return-to-Work Requirement</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>What About Tax and National Insurance?</Text>
      <Text style={styles.articleBody}>
      ...
      <Text style={styles.articleHeading}>Use Our Calculator to See Your Figures</Text>
      <Text style={styles.articleBody}>
